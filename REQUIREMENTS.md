...
- Basic understanding of WordPress, HTML, or Astro
- Practical use of AI tools
- GitHub and website deployment
- Ability to understand and explain your own work
...
- There should be **no obvious broken layout or horizontal scrolling** on mobile devices.
...
- Simple hover effects or micro-interactions are welcome.
- **NOT Required:** No booking backend, payment gateway, database, or real travel API is required.
...
- **Chosen Technology:** `WordPress / HTML / Astro`
- **GitHub Repository:** `[GitHub URL]`
- **Live Website / Staging URL:** `[Deployment URL]`
- **AI Tools Used:** `[List AI tools used]`
- **Approx. Time Taken:** `[e.g., 3-4 Hours]`
...
4. **Good design sense**
5. **Practical AI usage**
6. **Learning ability and problem solving**
7. **Ability to explain your implementation**
